...
An [instance](https://blyzp.github.io/calculator/) of the project [*Calculator*](https://www.theodinproject.com/paths/foundations/courses/foundations/lessons/calculator) from the ***Foundations*** path of **The Odin Project**. Originally uploaded on Jan 12, 2022.
